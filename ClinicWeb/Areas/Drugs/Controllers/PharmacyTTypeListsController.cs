...
{
    [Area("Drugs")]
    public class PharmacyTTypeListsController : Controller
    {
        private readonly ClinicSysContext _context;

        public PharmacyTTypeListsController(ClinicSysContext context)
        {
            _context = context;
        }
        
        // GET: Drugs/PharmacyTTypeLists
        ...
        // GET: Drugs/PharmacyTTypeLists/Details/5
        ...
        // GET: Drugs/PharmacyTTypeLists/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Drugs/PharmacyTTypeLists/Create
        ...
        // GET: Drugs/PharmacyTTypeLists/Edit/5
        ...
        // POST: Drugs/PharmacyTTypeLists/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Drugs/PharmacyTTypeLists/Delete/5
        ...
        // POST: Drugs/PharmacyTTypeLists/Delete/5
